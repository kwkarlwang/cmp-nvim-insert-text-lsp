...
M.setup = function()
	vim.cmd([[
    augroup cmp_nvim_insert_text_lsp
      autocmd!
      autocmd InsertEnter * lua require'cmp_nvim_insert_text_lsp'._on_insert_enter()
    augroup END
  ]])
end
...
M.update_capabilities = function(capabilities, override)
	...
	completionItem.snippetSupport = if_nil(override.snippetSupport, false)
